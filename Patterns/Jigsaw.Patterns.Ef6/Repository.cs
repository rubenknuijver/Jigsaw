    ...
    public class Repository<TEntity> : IRepositoryAsync<TEntity> where TEntity : Entity
    {
        ...
        public Repository(IDataContextAsync context, IUnitOfWorkAsync unitOfWork)
        {
            ...
            if (dbContext != null) {
                ...
                var fakeContext = context as Fakes.IFakeDbContext;
                if (fakeContext != null) {
        ...
        internal async Task<IEnumerable<TEntity>> SelectAsync(Expression<Func<TEntity, bool>> query = null, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy = null, List<Expression<Func<TEntity, object>>> includes = null, int? page = null, int? pageSize = null)
        {
